...
public class GestionCampeonato extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton3.setText("Tabla Posiciones");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
            ...
            if((CampeonatoController.getInstance().getSelected().getEquipos().size()!=1)&&(!CampeonatoController.getInstance().getSelected().getEquipos().isEmpty())){
            Campeonato campeonato = new Campeonato();
            campeonato.crearFechas();
            JOptionPane.showMessageDialog(this, "El Campeonato ha comenzado");
            ...
            JOptionPane.showMessageDialog(null, "Deben haber mínimo 4 equipos");
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GestionCampeonato.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
